...
```{r}
hotels$seasons <- ifelse(hotels$arrival_date_month == "December" | hotels$arrival_date_month == "January" | hotels$arrival_date_month =="February", "Winter", ifelse(hotels$arrival_date_month == "March" | hotels$arrival_date_month == "April" | hotels$arrival_date_month ==  "May",  "Spring", ifelse(hotels$arrival_date_month == "September" | hotels$arrival_date_month == "October" | hotels$arrival_date_month == "November", "Fall", "Summer")))
library("ggplot2")
...
```
This bar chart depicts another visual of the seasonal changes in arrivals for both hotels. Again, both hotels see the most arrivals in summer and the least in winter. The city hotel sees more drastic changes than the resort hotel as seen on the previous monthly distribution bar plot.
...
print(city_hotel + labs(y = "Number of Customers", x = "Bookings" , title = "City Hotels Booking Status")) #Graph to show the city hotel cancellation
...
print(resort_hotel + labs(y = "Number of Customers", x = "Bookings" , title = "Resort Hotels Booking Status")) #Graph to show the resort hotel cancellation
...
ggplot(hotels, aes(x = lead_time, y = days_in_waiting_list)) + geom_point() # point plot to show the relationship between days in waiting list and lead time
