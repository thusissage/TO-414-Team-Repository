...
ggplot(hotels, aes(x=booking_changes, fill = is_canceled)) +
  ...
  scale_fill_discrete(labels=c("Not Canceled", "Canceled"))
```
Above are histograms showing the count of bookings by number of booking changes for each hotel. We see that with each hotel, the vast majority of bookings are not changed.
