...
Setup
```{r}
hotels <- read.csv("C:\\Users\\otsage\\Desktop\\WN 2021\\TO\\hotel_bookings.csv") #Reads in Hotel Bookings Data
...
Meals 
```{r}
table(hotels$meal[hotels$hotel == "City Hotel"])
table(hotels$meal[hotels$hotel == "Resort Hotel"])
```
